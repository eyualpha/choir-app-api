...
rosterRouter.get("/:userId", isAuthenticated, asyncHandler(rosterController.getProfile));
rosterRouter.put("/:userId", isAuthenticated, asyncHandler(rosterController.upsertProfile));
